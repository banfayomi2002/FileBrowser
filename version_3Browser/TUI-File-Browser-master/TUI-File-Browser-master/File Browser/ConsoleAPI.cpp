...
*/
//void ConsoleAPI::GetEvent(vector<INPUT_RECORD>& buffer) {
//	
//
//		 std::vector<INPUT_RECORD> events(128);
//		 DWORD nEvents;
//
//		 THROW_IF_CONSOLE_ERROR(ReadConsoleInput(hStdIn_, buffer.data(), buffer.size(), &nEvents));
//	 // e = Event::Event(events[0]);
//	 
//
//
//	
...
//ConsoleAPI::Event ConsoleAPI::getConsoleInput(vector<INPUT_RECORD>& buffer, DWORD& num)
//{
//	buffer = vector<INPUT_RECORD>(128);
//	THROW_IF_CONSOLE_ERROR(ReadConsoleInput(hStdIn_, buffer.data(), buffer.size(), &num));
//}
/**
